...
$resultados = $objCategoria->consultar_vista($conexion);
...
<html lang="en">
  ...
  <div class="container">
      ...
      <header class="masthead mb-auto">
        <div class="inner">          
          <h4 class="cover-heading">Listado de Categorias</h4>
          <br>
          ...
          <tbody>
              ...
              ?>
                    <tr>
                        ...
                        <td><?php echo $resultados2['descripcion'] ?></td>
                        <td><a href="editar_cat.php?id=<?php echo $resultados2['id_cat'];?> "><img src="Imagenes/editar.png" width="25" height="25" ></a></td>
                        <td><a href="controlador/eliminar_cat.php?id=<?php echo $resultados2['id_cat']; ?>"><img src="Imagenes/drop.png" width="25" height="25" > </a></td>
                    </tr>
                <?php        
                    }
                ?>
