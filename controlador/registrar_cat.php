...
$objCategoria = new categoria();
 $respuesta=$objCategoria->registrar($conexion, $_POST['nombre'], $_POST['descripcion']);
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        ...
        <p class="lead">
            ...
            <button type="button" class="btn btn-primary btn-sm" onclick = "location='../RegistroCat.html'" > Volver </button>
        </p>
      </main>
