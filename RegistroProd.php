    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      <header class="masthead mb-auto">
        <div class="inner">          
          ...
          <h4 class="cover-heading">Registrar Producto</h4>
        </div> <!--id,nombre,valor,cantidad,categoria-->
        
        <form  action="controlador/registrar_prod.php" method="POST">
            <input class="form-control form-control-sm" type="text" placeholder="Nombre" name="nombre" required>
            <br>
            <input class="form-control form-control-sm" type="number" placeholder="Valor" name="valor" required>
            <br>
            <input class="form-control form-control-sm" type="number" placeholder="Cantidad" name="cantidad" required>
            <br>
            ...
            <input class="btn btn-primary btn-sm btn-block" type="submit" required value="Registrar">
        </form>
        <br>
